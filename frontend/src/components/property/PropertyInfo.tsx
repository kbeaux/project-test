...
export function PropertyInfo({
  ...
  return <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="space-y-6">
        <div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-600">{property.surface}{t("m.")}</span>
            </div>
            <div className="flex items-center">
        ...
        {property.features.length > 0 && <div className="border-t pt-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">{t("features")}</h2>
            <ul className="grid grid-cols-2 gap-4">
              {property.features.map((feature, index) => <li key={index} className="flex items-center text-gray-600">
        ...
        {property.heating && <div className="border-t pt-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">{t("additional.information")}</h2>
