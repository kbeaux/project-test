...
export function PropertyShare({ property, onClose }: PropertyShareProps) {
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {isEmailFormOpen && (
            <form onSubmit={handleEmailShare} className="mt-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={t("recipient.s.email")}
                  required
